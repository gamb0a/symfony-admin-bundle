...
class RegisterRequestTest extends TestCase
{
    ...
    {
        return [
            ['31177706-8', 'nicolas', 'nn@gmail.com', 'password11!', 'password11!', 31177706, '8'],
            ['37669903-K', 'peter escariola', 'peter@hotmail.com', 'passw0rd11!', 'passw0rd11!', 37669903, 'K'],
        ];
    }
    ...
    {
        return [
            ['1.245.009-5', 'nicolas', 'invalid_email', '', 'invalid_confirmation'],
            ['27.767.951-5', 'dummyame', 'nn@gmail.com', '', 'pasword'],
            ['0000000', 'dummyame', 'nn@gmail.com', 'correctPass', 'correctPass'],
            ['32393785-0', 'dummyame', 'nn@gmail.com', 'correctPass', 'incorrectPass'],
            ['17807823-2', '', 'nn@gmail.com', 'correctPass', 'correctPass'],
            [null, 'dummyame', 'nn@gmail.com', '', ''],
        ];
    }
}
